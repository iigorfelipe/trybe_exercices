...
// Criamos um objeto onde suas chaves são as estações e seus valores são os meses.
// Note abaixo um segundo objeto onde, sendo do hemisfério oposto, as estações são opostas também
...
Object.entries(chosenHemisphereSeasons).map((entry) => {
    ...
    // São os meses de cada estação. Caso esteja incluído em mais de uma estação,
    // o console abaixo irá adicionar
